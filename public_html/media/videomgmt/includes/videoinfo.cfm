<cfif NOT thereAreErrors> <!--- thereAreErrors is defined in /display/errors.cfm --->
	<cfinvoke component="#application.objvideolib#" method="getVideos" videodsn='#client.siteurl#' vid="#url.v#" returnvariable="videoInfo">
	...
	<cfset Session.formValues['imagepath']=videoinfo.imagepath>
