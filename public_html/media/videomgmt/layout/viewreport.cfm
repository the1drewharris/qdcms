...
<cfinvoke component="#application.objvideolib#" method="getCompletedViewCount" argumentcollection="#args#" returnvariable="completedViewCount">
...
<cfoutput>
	<div class="info">
		...
		<h4>Total Views: #viewCount#</h4>
		<h4>Total Unique Views: #uniqueViewCount#</h4>
		<h4>Watched End: #completedViewCount#</h4>
	</div>
