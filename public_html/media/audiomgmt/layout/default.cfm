				...
				<div id="content">
					...
					<cfswitch expression="#url.action#">
						...
						<cfcase value="editalbum">
							...
							<cfinclude template="../includes/audioalbuminfo.cfm">
							<cfinclude template="addeditalbum.cfm">
						</cfcase>
						<cfcase value="addaudio">
							<cfset title="Add Audio">
							<cfset formaction="actionaddaudio">
							<cfinclude template="addeditaudio.cfm">
						</cfcase>
						<cfcase value="editaudio">
							<cfset title="Edit Audio">
							<cfset formaction="actioneditaudio">
							<cfinclude template="../includes/audioinfo.cfm">
							<cfinclude template="addeditaudio.cfm">
						</cfcase>
						<cfcase value="inactiveaudios">
							<cfinclude template="inactiveaudios.cfm">
						</cfcase>
						<cfcase value="listenaudio">
							<cfinclude template="listenaudio.cfm">
						</cfcase>
						...
						<cfcase value="addfile">
							...
							<cfinclude template="addfile.cfm">
						</cfcase>
						<cfdefaultcase>
