<cfoutput>
	...
	<cfinvoke component="#application.objvideolib#" method="getAudioCategory" videodsn="#client.siteurl#" criteria="#url.s#" returnvariable="albums">
			...
			<cfloop query="albums">
				<li id="#videocategoryid#" class="sortCell">
					...
					<center>
						...
						<span class="quickGalleryInfo">Audios: #audiocount#</span>
