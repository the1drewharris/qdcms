...
<cfoutput>
	<cfif url.newsletterid NEQ 0>
		...
		<cfinvoke component="#application.objnewsletter#" method="getBounceCount" ds="#client.siteurl#" newsletterid="#url.newsletterid#" returnvariable="bounceCount">
		<div class="report">
			...
			<table class="datagrid" width="910">
				...
				<tr>
					...
					<td>#(result.noofemails-(viewcount+bouncecount))# (<a href="/cms/marketing/newsletter/detailreport/?newsletterid=#url.newsletterid#&s=5">Detail</a>)</td>
				</tr>
			</table> <br /><br />
		
			<div class="clear"></div>
			<h3>Graph of Views Per Day(Last 14 Days)</h3>
			<div class="view-per-day"><!--- put graph here. show for a month --->
				...
				<cfset lastviewed=Application.objtimedateconversion.convertDate(lastviewed)>
				<cfchart format = "jpg" show3D="no" tipStyle="mouseOver" showborder="yes" chartWidth="910" xaxistitle="Date" yaxistitle="No of views" showXGridLines="yes" title="View by day">
					<cfchartseries type="bar">
						...
						<cfloop query="views">
							...
							<cfchartdata item="#Application.objtimedateconversion.convertDate(date,'mmm-dd')#" value="#VIEWPERDAY#">
						</cfloop>
					</cfchartseries>
				</cfchart>
			</div>
	<cfelse>
		<cflocation url="/marketing/newsletter/shownewsletters" addtoken="false">
	</cfif>
</cfoutput>