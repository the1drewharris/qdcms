<cfoutput>
	...
	<cfparam name="url.zoneid" default="1">
	<cfinvoke component="#application.objadmanagement#" method="getBannerAd" returnvariable="bannerad" admanagementdsn="#client.siteurl#" zoneid="#url.zoneid#" sortorder="bannerad.adname">
	<h3>Zone: #bannerad.description#</h3>
		...
		<cfloop query="bannerad">
			...
			<tr>
				...
				<td class="name"><a href="/cms/marketing/admanagement/editadvertisement/?adid=#adid#">#adname#</a><br />
					<span class="small"><strong>Advertiser:</strong> <a href="/cms/marketing/admanagement/advertiserDashboard/?advertiserID=#advertiser_nameid#">#company#</a></span>
				</td>
				...
				<td><div class="#dateClass#">#application.objtimedateconversion.convertDate(startdate,"m/d/yy")# #application.objtimedateconversion.convertTime(startdate,"hh:mmtt")# &mdash; #application.objtimedateconversion.convertDate(enddate,"m/d/yy")# #application.objtimedateconversion.convertTime(enddate,"hh:mmtt")#</div></td>
				<td><a href="/cms/marketing/admanagement/showimpressions/?adid=#adid#">Show</a></td>		<td align="center">
					<a href="/cms/marketing/admanagement/deletead/?adid=#adid#&advertiserid=#url.zoneid#">
						<img src="/marketing/admanagement/images/delete.png">
					</a>
				</td>
			</tr>
		</cfloop>
