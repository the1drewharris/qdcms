		...
		<table id="webPageEditorTable"  class="htmform" cellpadding="3">
		  	<tr>
				<td class="mainWebPageInfo">
					<fieldset>
						<cfif url.action EQ "addnewsite">
							<label class="name">First Name
							 	<input type="text" name="firstname" value="#application.objtextconversion.setformValue('firstname')#" />
							</label>
							
							<label class="name">Last Name
							 	<input type="text" name="lastname" value="#application.objtextconversion.setformValue('lastname')#" />
							</label>
							
							<label class="name">Password (<i>For Email and QDCMS Account</i>)
							 	<input type="text" name="pw" value="#application.objtextconversion.setformValue('pw')#" />
							</label>
						</cfif>
						...
						<label class="name">Site URL
							<input type="text" name="siteurl" value="#application.objtextconversion.setformValue('siteurl')#" />
						</label>
				...
				<td class="quickWebPageInfo">
					<div class="container">
						<cfif client.roleid gt 4>
							<h2>Select Modules</h2> <br />
							<cfinclude template="/administration/site/display/modulelist.cfm">
						</cfif>
					</div>
				</td>
		 	</tr>
